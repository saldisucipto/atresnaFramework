<template>
    <div class="p-3 rounded-xl bg-white flex flex-col gap-4">
        <!-- Title Pages -->
        <title-pages> Company History </title-pages>
        <!-- Endt Title Pages -->
        <!-- Mesasge -->
        <div
        ...
        <div class="flex justify-end mb-10">
            ...
            >
                <i class="fas fa-plus"></i> History Company
            </button>
        </div>
        <!-- Main menu  -->
                ...
                <div class="mx-auto w-2/4 bg-white drop-shadow-lg rounded-lg">
                    ...
                    >
                        <div class="flex flex-col gap-2">
                            <label class="text-gray-700">Tahun History</label>
                            <input
                        ...
                        <div v-if="updateMode" class="flex justify-center">
                            ...
                            <div v-else>
                                <img
                                    ...
                                    :src="'/storage/img/history/' + this.image"
                                    alt=""
                                />
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        showData(id) {
            ...
            this.form.description = this.singelData[0].descripiton;
            this.form.tahun = this.singelData[0].tahun;
            this.image = this.singelData[0].icon;
        },
        imagesShow(img) {
        ...
        submitForm() {
            if (!this.updateMode) {
                router.post("/dashboard/master/history/create", this.form, {
                    preserveScroll: true,
                    onSuccess: () => {
                        this.closedModal();
                    },
                ...
                router.post(
                    "/dashboard/master/history/update/" + this.singelData[0].id,
                    this.form,
                    {
                        preserveScroll: true,
                        onSuccess: () => {
