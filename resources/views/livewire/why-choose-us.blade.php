<div class="flex flex-col  bg-primary justify-center h-hero gap-20 overflow-hidden  ">
    <div class=" text-gray-200 font-semibold text-4xl text-center w-full ">
        <h1 class=" capitalize">Alasan bermitra dengan</h1>
        <span>Narayana Consulting</span>
    </div>
    <div class="  w-full  ">
        <div class=" grid gap-6 grid-flow-col grid-cols-3 w-full  max-w-screen-lg  mx-auto">
            @foreach ($dataStatic as $item)
                <div class=" bg-white h-96 rounded-tl-3xl rounded-br-3xl">
                    ...
                    <div class="m-3 flex flex-col gap-2">
                        ...
                        <p class="text-center font-semibold text-sm text-gray-800">
